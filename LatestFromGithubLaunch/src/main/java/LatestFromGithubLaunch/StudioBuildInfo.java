...
public class StudioBuildInfo {
  ...
  private static Class baseBuildInfoClass = LatestFromGithubLaunchUI.class;
  ...
  public static boolean isAarch64() {
	    return (System.getProperty("os.arch").toLowerCase().contains("aarch"));
	  }
...
public static boolean isM1MacOS() {
	if(isM1MacOS())
		if(isAarch64())
			return true;
	return false;
